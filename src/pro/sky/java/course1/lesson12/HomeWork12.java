...
public class HomeWork12{
    public static void main(String[] args) {
        ...
        firstBook.printInformationAboutABook(firstBook); // вызов метода вывода информации о книге класса Book
        secondBook.printInformationAboutABook(secondBook); // вызов метода вывода информации о книге класса Book
        firstBook.setPublishingYear(2040); //изменение даты публикации первой книги с использованием сеттера
        firstBook.printInformationAboutABook(firstBook); //вызов метода вывода информации о книге класса Book (после изменения даты публикации первой книги)
    }
}
